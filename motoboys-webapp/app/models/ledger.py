...
class LedgerEntry(Base):
    ...
    courier_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("couriers.id", ondelete="CASCADE"), nullable=False)
    ...
    related_ride_id: Mapped[uuid.UUID | None] = mapped_column(
        GUID(), ForeignKey("rides.id", ondelete="SET NULL"), nullable=True
    )
